...
public class Tables extends JFrame {
	...
	private JButton famousspotbtn;
	private JButton atmsbtn;
	private JButton cinemabtn;
	private JButton shoppingbtn;
	private JButton restaurantsbtn;
	private JButton publictbtn;
	private JButton hospitalsbtn;
	private JButton policestationsbtn;
	private JButton btnViewUniversities;
	private JButton btnViewSchools;
	private JButton btnViewHostels;
	private JButton btnViewLibraries;
	private JButton btnViewAirport;
	...
	private JTextField txtTiming_2;
	...
	public Tables() {
		...
		panel.setBounds(530, 128, 817, 402);
		...
		hotelbtn.setBounds(45, 83, 187, 33);
		hotelbtn.addActionListener(e -> {setMain("Hotel");});
		...
		famousspotbtn.setBounds(45, 145, 187, 33);
		famousspotbtn.addActionListener(e -> {setMain("Spots");});
		...
		atmsbtn.setBounds(45, 206, 187, 33);
		atmsbtn.addActionListener(e -> {setMain("ATM");});
		...
		cinemabtn.setBounds(45, 269, 187, 33);
		cinemabtn.addActionListener(e -> {setMain("Cinema");});
		...
		shoppingbtn.setBounds(45, 330, 187, 33);
		shoppingbtn.addActionListener(e -> {setMain("Shopping");});
		...
		restaurantsbtn.setBounds(45, 395, 187, 33);
		restaurantsbtn.addActionListener(e -> {setMain("Resturant");});
		...
		publictbtn.setBounds(45, 458, 187, 33);
		publictbtn.addActionListener(e -> {setMain("Transport");});
		...
		hospitalsbtn.setBounds(268, 458, 187, 33);
		hospitalsbtn.addActionListener(e -> {setMain("Hospitals");});
		...
		policestationsbtn.setBounds(268, 330, 187, 33);
		policestationsbtn.addActionListener(e -> {setMain("Police Stations");});
		contentPane.add(policestationsbtn);
		
		btnViewUniversities = new JButton("view Universities");
		btnViewUniversities.setForeground(Color.WHITE);
		btnViewUniversities.setFont(new Font("Times New Roman", Font.PLAIN, 17));
		btnViewUniversities.setBackground(Color.BLACK);
		btnViewUniversities.setBounds(268, 395, 187, 33);
		btnViewUniversities.addActionListener(e -> {setMain("Universities");});
		contentPane.add(btnViewUniversities);
		
		btnViewSchools = new JButton("view Schools");
		btnViewSchools.setForeground(Color.WHITE);
		btnViewSchools.setFont(new Font("Times New Roman", Font.PLAIN, 17));
		btnViewSchools.setBackground(Color.BLACK);
		btnViewSchools.addActionListener(e -> {setMain("School");});
		btnViewSchools.setBounds(268, 83, 187, 33);
		contentPane.add(btnViewSchools);
		
		btnViewHostels = new JButton("view Hostels");
		btnViewHostels.setForeground(Color.WHITE);
		btnViewHostels.setFont(new Font("Times New Roman", Font.PLAIN, 17));
		btnViewHostels.setBackground(Color.BLACK);
		btnViewHostels.setBounds(268, 145, 187, 33);
		btnViewHostels.addActionListener(e -> {setMain("Hostel");});
		contentPane.add(btnViewHostels);
		
		btnViewLibraries = new JButton("view Libraries");
		btnViewLibraries.setForeground(Color.WHITE);
		btnViewLibraries.setFont(new Font("Times New Roman", Font.PLAIN, 17));
		btnViewLibraries.setBackground(Color.BLACK);
		btnViewLibraries.setBounds(268, 206, 187, 33);
		btnViewLibraries.addActionListener(e -> {setMain("Library");});
		contentPane.add(btnViewLibraries);
		
		btnViewAirport = new JButton("view Airport");
		btnViewAirport.setForeground(Color.WHITE);
		btnViewAirport.setFont(new Font("Times New Roman", Font.PLAIN, 17));
		btnViewAirport.setBackground(Color.BLACK);
		btnViewAirport.setBounds(268, 269, 187, 33);
		btnViewAirport.addActionListener(e -> {setMain("Airport");});
		contentPane.add(btnViewAirport);
		...
		panel_10.setBackground(new Color(204, 204, 255));
		panel_10.setBounds(0, 0, 817, 39);
		panel.add(panel_10);
		
		textField = new JTextField();
		textField.setText("Serial No.");
		textField.setHorizontalAlignment(SwingConstants.CENTER);
		textField.setFont(new Font("Book Antiqua", Font.BOLD | Font.ITALIC, 18));
		textField.setColumns(10);
		textField.setBackground(new Color(204, 204, 255));
		textField.setBounds(0, 0, 160, 39);
		panel_10.add(textField);
		
		textField_27 = new JTextField();
		textField_27.setText("Name");
		textField_27.setHorizontalAlignment(SwingConstants.CENTER);
		textField_27.setFont(new Font("Book Antiqua", Font.BOLD | Font.ITALIC, 18));
		textField_27.setColumns(10);
		textField_27.setBackground(new Color(204, 204, 255));
		textField_27.setBounds(160, 0, 160, 39);
		panel_10.add(textField_27);
		
		textField_28 = new JTextField();
		textField_28.setText("Location");
		textField_28.setHorizontalAlignment(SwingConstants.CENTER);
		textField_28.setFont(new Font("Book Antiqua", Font.BOLD | Font.ITALIC, 18));
		textField_28.setColumns(10);
		textField_28.setBackground(new Color(204, 204, 255));
		textField_28.setBounds(320, 0, 160, 39);
		panel_10.add(textField_28);
		
		txtTiming_2 = new JTextField();
		txtTiming_2.setText("Timing");
		txtTiming_2.setHorizontalAlignment(SwingConstants.CENTER);
		txtTiming_2.setFont(new Font("Book Antiqua", Font.BOLD | Font.ITALIC, 18));
		txtTiming_2.setColumns(10);
		txtTiming_2.setBackground(new Color(204, 204, 255));
		txtTiming_2.setBounds(480, 0, 160, 39);
		panel_10.add(txtTiming_2);
		
		txtPrice_3 = new JTextField();
		txtPrice_3.setText("Price");
		txtPrice_3.setHorizontalAlignment(SwingConstants.CENTER);
		txtPrice_3.setFont(new Font("Book Antiqua", Font.BOLD | Font.ITALIC, 18));
		txtPrice_3.setColumns(10);
		txtPrice_3.setBackground(new Color(204, 204, 255));
		txtPrice_3.setBounds(640, 0, 160, 39);
		panel_10.add(txtPrice_3);
		...
		scrollPane.setBounds(0, 37, 817, 364);
		...
		table_1.setFont(new Font("Bookman Old Style", Font.PLAIN, 10));
		...
		txtName.setBounds(133, 0, 133, 39);
		panel_1.add(txtName);
		...
		btnBack_2.setFont(new Font("Times New Roman", Font.PLAIN, 17));
		btnBack_2.setBackground(Color.BLACK);
		btnBack_2.setBounds(142, 525, 187, 33);
		btnBack_2.addActionListener(e-> {showAdmin();});
		contentPane.add(btnBack_2);
		
		lblNewLabel = new JLabel("New label");
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\hp\\Desktop\\Project Images\\library-books-education-literature.jpg"));
		lblNewLabel.setBounds(0, 0, 490, 595);
		...
		btnNewButton.setBounds(871, 541, 133, 36);
		btnNewButton.addActionListener(e-> {getValue(table_1);});
	...
	public void setMain(String information) {
		...
		DB.display_universities(table_1);
		}
		...
		DB.display_schools(table_1);
		
		
		}
		

		else if (information == "Hostel")
		...
		DB.display_hostels(table_1);
		}
		else if (information == "Resturant")
		...
		DB.display_restaurants(table_1);
		}
